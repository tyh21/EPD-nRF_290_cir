...
// GPIO Pins
static uint32_t EPD_MOSI_PIN = 20;
static uint32_t EPD_SCLK_PIN = 19;
static uint32_t EPD_CS_PIN = 6;
static uint32_t EPD_DC_PIN = 5;
static uint32_t EPD_RST_PIN = 4;
static uint32_t EPD_BUSY_PIN = 3;
static uint32_t EPD_BS_PIN = 2;
static uint32_t EPD_EN_PIN = 7;
static uint32_t EPD_LED_PIN = 16;
...
extern epd_model_t epd_ssd1619_290_bwr;  // 新增：2.9寸三色
